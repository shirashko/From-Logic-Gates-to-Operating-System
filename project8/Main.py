...
def translate_file(input_file: typing.TextIO, output_file: typing.TextIO, bootstrap: bool) -> None:
    ...
    XxxVME.tst script (if the program consists of one or more files residing
    ...
    while parser.has_more_commands():
        if parser.command_type() == "C_ARITHMETIC":
            code_writer.write_arithmetic(parser.arg1())  # In case of  "C_ARITHMETIC", the command itself
            # (add, sub, etc.) is returned.
        elif parser.command_type() == "C_PUSH":
            code_writer.write_push_pop("push", parser.arg1(), parser.arg2())
            # make sure I suppose to sent "push" like that
