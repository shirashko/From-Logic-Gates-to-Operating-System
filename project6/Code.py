...
class Code:
    ...
    def dest(mnemonic: str) -> str:
        ...
        """
        # Your code goes here!
        dest_dict = {"": "000", "M": "001", "D": "010", "DM": "011", "MD": "011", "A": "100", "AM": "101",
                     "AD": "110", "ADM": "111"}
        return dest_dict.get(mnemonic.strip())
    ...
    def comp(mnemonic: str) -> str:
        ...
        comp_dict = {"0": "0101010", "1": "0111111", "-1": "0111010", "D": "0001100", "A": "0110000",
                     ...
                     "M-D": "1000111", "D&M": "1000000", "D|M": "1010101", "D>>": "0010000",
                     "A>>": "0000000", "M>>": "1000000", "D<<": "0110000", "A<<": "0100000",
                     "M<<": "1100000"}
        return comp_dict.get(mnemonic.strip())
    ...
    def jump(mnemonic: str) -> str:
        ...
        """
        # Your code goes here!
        jump_dict = {"": "000", "JGT": "001", "JEQ": "010", "JGE": "011", "JLT": "100", "JNE": "101",
                     "JLE": "110", "JMP": "111"}
        return jump_dict.get(mnemonic.strip())
