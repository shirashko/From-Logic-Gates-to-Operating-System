...
class SymbolTable:
    ...
    def __init__(self) -> None:
        ...
        """
        # Your code goes here!
        self.table = {"R0":"0", "R1":"1", "R2":"2", "R3":"3", "R4":"4", "R5":"5", "R6":"6", "R7":"7", "R8":"8",
    ...
    def add_entry(self, symbol: str, address: int) -> None:
        ...
        """
        # Your code goes here!
        self.table[symbol] = address # what to do if two symbols are the same? we suppose to overwrite it?
    ...
    def contains(self, symbol: str) -> bool:
        ...
        """
        # Your code goes here!
        return self.table.__contains__(symbol)
