...
class VMWriter:
    ...
    """
    segments_dict = {"CONST": "constant", "ARG": "argument", "LOCAL": "local", "STATIC": "static", "THIS": "this",
    ...
    def write_push(self, segment: str, index: int) -> None:
        ...
        """
        # Your code goes here!
        self.output_file.write(f"push {self.segments_dict[segment]} {index}\n")  # todo need \n ?
    ...
    def write_pop(self, segment: str, index: int) -> None:
        ...
        """
        # Your code goes here!
        self.output_file.write(f"pop {self.segments_dict[segment]} {index}\n")
    ...
    def write_arithmetic(self, command: str) -> None:
        ...
        """
        # Your code goes here!
        self.output_file.write(f"{command.lower()}\n")  # todo check how shifts suppose to be written
